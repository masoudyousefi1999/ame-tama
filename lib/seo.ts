...
export const defaultSEO: SEOProps = {
  ...
  description:
    "فروشگاه آنلاین مجسمه‌های انیمه لوکس با کیفیت استثنایی و جزئیات خیره‌کننده برای کلکسیونرهای مشتاق",
  keywords: [
    "مجسمه انیمه",
    "فیگور انیمه",
    "مجسمه لوکس",
...
export function mergeSEO(customSEO?: Partial<SEOProps>): SEOProps {
  return {
    ...
    description:
      ...
      "فروشگاه آنلاین مجسمه‌های انیمه با کیفیت و اورجینال - خرید مجسمه انیمه",
