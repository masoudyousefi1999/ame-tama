        ...
        <Table>
          ...
          <TableBody>
            {addresses.map((address, index) => (
              ...
              >
                <TableCell className="font-medium text-gray-900 dark:text-gray-100 font-vazirmatn">
                  {address.user}
                </TableCell>
                <TableCell className="text-gray-600 dark:text-gray-400 font-vazirmatn">{address.province}</TableCell>
                <TableCell className="text-gray-600 dark:text-gray-400 font-vazirmatn">{address.city}</TableCell>
                <TableCell className="max-w-xs truncate text-gray-600 dark:text-gray-400 font-vazirmatn">
                  {address.address}، واحد {address.houseNumber}، طبقه {address.floorNumber}
                </TableCell>
                <TableCell className="text-gray-600 dark:text-gray-400 font-vazirmatn">{address.postalCode}</TableCell>
                      ...
                      <AlertDialogContent className="bg-white dark:bg-gray-800" dir="rtl">
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription className="text-gray-600 dark:text-gray-400 font-vazirmatn">
                            این عمل قابل بازگشت نیست. این کار آدرس را به طور دائم حذف خواهد کرد.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          ...
                          >
                            {isDeleting === address.id ? "در حال حذف..." : "حذف"}
                          </AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
                    </AlertDialog>
