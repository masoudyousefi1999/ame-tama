...
export function WalletTransactions({ transactions }: WalletTransactionsProps) {
  return (
    <Card className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border-gray-200 dark:border-gray-700" dir="rtl">
              ...
              <TableBody>
                {transactions.map((transaction, index) => (
                  ...
                  >
                    ...
                    <TableCell className="text-gray-900 dark:text-gray-100 font-vazirmatn">
                      {transaction.description}
                    </TableCell>
                    <TableCell
                      className={`font-semibold font-vazirmatn ${transaction.type === "income" ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
                    >
                      {transaction.type === "income" ? "+" : "-"}${transaction.amount.toLocaleString("fa-IR")}
                    </TableCell>
                    <TableCell className="text-gray-600 dark:text-gray-400 font-vazirmatn">
