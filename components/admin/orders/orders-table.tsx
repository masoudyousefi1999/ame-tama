          ...
          <TableBody>
            {orders.map((order, index) => (
              ...
              >
                ...
                <TableCell className="text-gray-600 dark:text-gray-400 font-vazirmatn">{order.user}</TableCell>
                <TableCell className="font-semibold text-gray-900 dark:text-gray-100 font-vazirmatn">
                  ${order.totalPrice.toLocaleString("fa-IR")}
                </TableCell>
                <TableCell className="font-semibold text-green-600 dark:text-green-400 font-vazirmatn">
