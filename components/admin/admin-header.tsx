      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white font-vazirmatn hidden sm:block">
              پنل مدیریت
            </h2>
          </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <Badge 
                      className="absolute -top-1 -right-1 h-5 w-5 p-0 flex items-center justify-center bg-red-500 text-white text-xs font-vazirmatn"
                    >
                      {unreadCount}
                    </Badge>
                  )}
              ...
              <DropdownMenuContent className="w-80" align="end">
                <div className="flex items-center justify-between p-2 border-b border-gray-200 dark:border-gray-700">
                  <h3 className="font-semibold text-gray-900 dark:text-white font-vazirmatn">اعلان‌ها</h3>
                  {unreadCount > 0 && (
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      onClick={markAllAsRead}
                      className="text-xs text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-vazirmatn"
                    >
                ...
                <div className="max-h-80 overflow-y-auto py-1">
                  {notifications.length === 0 ? (
                    <div className="p-4 text-center text-gray-500 dark:text-gray-400 font-vazirmatn">
                      اعلان جدیدی ندارید
                    </div>
                  ) : (
                    notifications.map((notification) => (
                      <DropdownMenuItem 
                        key={notification.id}
                        className={`p-3 cursor-pointer ${!notification.read ? 'bg-purple-50 dark:bg-purple-900/20' : ''}`}
                        onClick={() => markAsRead(notification.id)}
                      >
                        <div className="flex items-start gap-3" dir="rtl">
                          <div className={`h-2 w-2 mt-2 rounded-full flex-shrink-0 ${!notification.read ? 'bg-purple-500' : 'bg-gray-300 dark:bg-gray-600'}`} />
                          <div className="flex-1">
                            <p className="text-sm text-gray-900 dark:text-gray-100 font-vazirmatn">
                              {notification.title}
                            </p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 font-vazirmatn">
                              ۱۰ دقیقه پیش
                            </p>
                          </div>
                        </div>
                ...
                <div className="p-2 text-center">
                  <Link 
                    ...
                    className="text-sm text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-vazirmatn"
                  >
                    مشاهده همه اعلان‌ها
                  </Link>
                </div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end">
                ...
                <DropdownMenuItem className="p-3 cursor-pointer" dir="rtl">
                  ...
                  <span className="font-vazirmatn">پروفایل</span>
                </DropdownMenuItem>
                <DropdownMenuItem className="p-3 cursor-pointer" dir="rtl">
                  <Settings className="ml-2 h-4 w-4 text-gray-500 dark:text-gray-400" />
                  <span className="font-vazirmatn">تنظیمات</span>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem 
                ...
                >
                  ...
                  <span className="font-vazirmatn">خروج</span>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
