          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 space-y-6 sticky top-24">
            <div>
              ...
              <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                <span className="font-vazirmatn">{priceRange[0].toLocaleString("fa-IR")}K</span>
                <span className="font-vazirmatn">{priceRange[1].toLocaleString("fa-IR")}K</span>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <Label htmlFor="filter-limited" className="mr-2 text-sm font-vazirmatn">
                    نسخه‌های محدود
                  </Label>
                </div>
                <div className="flex items-center">
                  ...
                  />
                  <Label htmlFor="filter-in-stock" className="mr-2 text-sm font-vazirmatn">
                    فقط موجود
                  </Label>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  <input
                    ...
                    className="ml-2"
                  />
                  <Label htmlFor="sort-newest" className="text-sm font-vazirmatn">
                    جدیدترین
                  </Label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="ml-2"
                  />
                  <Label htmlFor="sort-price-asc" className="text-sm font-vazirmatn">
                    قیمت: کم به زیاد
                  </Label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="ml-2"
                  />
                  <Label htmlFor="sort-price-desc" className="text-sm font-vazirmatn">
                    قیمت: زیاد به کم
                  </Label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="ml-2"
                  />
                  <Label htmlFor="sort-popular" className="text-sm font-vazirmatn">
                    محبوب‌ترین
                  </Label>
                </div>
              </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Checkbox
                            ...
                            onCheckedChange={() => toggleFilter("new")}
                          />
                          <Label htmlFor="mobile-filter-new" className="mr-2 text-sm font-vazirmatn">
                            محصولات جدید
                          </Label>
                        </div>
                        <div className="flex items-center">
                          <Checkbox
                            ...
                            onCheckedChange={() => toggleFilter("limited")}
                          />
                          <Label htmlFor="mobile-filter-limited" className="mr-2 text-sm font-vazirmatn">
                            نسخه‌های محدود
                          </Label>
                        </div>
                        <div className="flex items-center">
                          <Checkbox
                            ...
                            onCheckedChange={() => toggleFilter("in-stock")}
                          />
                          <Label htmlFor="mobile-filter-in-stock" className="mr-2 text-sm font-vazirmatn">
                            فقط موجود
                          </Label>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <input
                            ...
                            className="ml-2"
                          />
                          <Label htmlFor="mobile-sort-newest" className="text-sm font-vazirmatn">
                            جدیدترین
                          </Label>
                        </div>
                        <div className="flex items-center">
                          <input
                            ...
                            className="ml-2"
                          />
                          <Label htmlFor="mobile-sort-price-asc" className="text-sm font-vazirmatn">
                            قیمت: کم به زیاد
                          </Label>
                        </div>
                        <div className="flex items-center">
                          <input
                            ...
                            className="ml-2"
                          />
                          <Label htmlFor="mobile-sort-price-desc" className="text-sm font-vazirmatn">
                            قیمت: زیاد به کم
                          </Label>
                        </div>
                        <div className="flex items-center">
                          <input
                            ...
                            className="ml-2"
                          />
                          <Label htmlFor="mobile-sort-popular" className="text-sm font-vazirmatn">
                            محبوب‌ترین
                          </Label>
                        </div>
                      </div>
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  {product.rating && (
                    <div className="absolute top-2 left-2 bg-amber-400 text-white text-xs font-bold rounded-full px-2 py-1 flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 fill-current ml-1" viewBox="0 0 24 24">
