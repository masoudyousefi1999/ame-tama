    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 space-y-6">
      ...
      <div>
        ...
        <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
          <span className="font-vazirmatn">{localPriceRange[0].toLocaleString("fa-IR")}K</span>
          <span className="font-vazirmatn">{localPriceRange[1].toLocaleString("fa-IR")}K</span>
        </div>
      </div>
      ...
      {(localFilters.length > 0 || localPriceRange[0] > 0 || localPriceRange[1] < 500) && (
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          <Button variant="outline" size="sm" className="w-full rounded-full font-vazirmatn" onClick={clearAllFilters}>
            پاک کردن فیلترها
          </Button>
        </div>
      )}
