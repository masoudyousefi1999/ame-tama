...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-10 items-center gap-x-1 rounded-md border border-border bg-background p-1",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    className={cn(baseDropdownStyle, className)}
    {...props}
  />
));
  ...
  (
    ...
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn("min-w-[12rem]", baseDropdownStyle, className)}
        {...props}
      />
    </MenubarPrimitive.Portal>
  )
