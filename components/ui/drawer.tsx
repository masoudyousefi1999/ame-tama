/* -------------------------------------------------------------------------- */
/*  Drawer (vaul) – token-based styles (tailwind / shadcn design-tokens)      */
/* -------------------------------------------------------------------------- */
"use client";
  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        /* surface */
        "rounded-t-2xl border border-border bg-card text-card-foreground shadow-lg",
        /* animations (vaul handles slide-in) */
        className
      )}
      {...props}
    >
