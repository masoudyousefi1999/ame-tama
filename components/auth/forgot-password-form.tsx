  ...
  if (isSubmitted) {
    return (
      <div className="space-y-6 text-center">
        ...
        <h3 className="text-2xl font-bold font-vazirmatn">ایمیل بازیابی ارسال شد</h3>

        <p className="text-gray-600 dark:text-gray-400 font-vazirmatn">
          لینک بازیابی رمز عبور به ایمیل <span className="font-semibold">{email}</span> ارسال شد. لطفاً صندوق ورودی خود
          را بررسی کنید.
        </p>

        <Button type="button" variant="outline" className="rounded-full font-vazirmatn" onClick={onBack}>
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <Button
            type="submit"
            className="rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 flex-1 font-vazirmatn"
            disabled={isLoading}
          >
            {isLoading ? (
              <>
