...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // بارگذاری اطلاعات کاربر از localStorage در هنگام اولین رندر
  useEffect(() => {
    const storedUser = localStorage.getItem("ame-tama-user")
  ...
  const login = async (email: string, password: string) => {
    try {
      ...
      localStorage.setItem("ame-tama-user", JSON.stringify(userWithoutPassword))
