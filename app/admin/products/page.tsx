...
async function getProducts(searchParams: { page?: string; limit?: string; search?: string }) {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 dark:border-gray-700 pb-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white font-vazirmatn">محصولات</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2 font-vazirmatn">مدیریت کاتالوگ محصولات</p>
        </div>
        <Button
          asChild
