      ...
      <body>
        <div className="container flex flex-col items-center justify-center min-h-screen py-12 text-center">
          <div className="mb-8 relative">
            <div className="text-9xl font-bold text-red-500/20 select-none">500</div>
            <div className="relative z-10 h-64 w-64 mx-auto">
              <img src="/placeholder.svg?height=256&width=256" alt="خطای سرور" className="h-64 w-auto mx-auto" />
            </div>
          </div>

          <div>
            <h1 className="text-3xl font-bold mb-4">خطای سیستمی رخ داده است!</h1>
            <p className="text-muted-foreground mb-8 max-w-md">
              متأسفانه یک خطای جدی در سیستم رخ داده است. تیم فنی ما در حال بررسی و رفع این مشکل است. لطفاً صفحه را دوباره
              بارگذاری کنید یا بعداً مراجعه نمایید.
            </p>
          </div>
