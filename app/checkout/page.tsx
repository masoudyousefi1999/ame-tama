...
export default function CheckoutPage() {
  ...
  return (
    <>
      ...
      {/* Mobile Sticky Footer - Outside container for better positioning */}
      {isMobile && (
        <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border p-4 z-[9999] shadow-lg backdrop-blur-sm">
